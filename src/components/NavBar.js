        ...
        <div>
            <nav className="navbar fixed-top navbar-expand-lg navbar-danger bg-danger">
                <div className="container-fluid">
                    <Link className="navbar-brand fs-2" to="/"><strong>NewsGorilla</strong></Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item fs-5 active-white"><Link className="nav-link" to="/business">Business</Link></li>
