...
// updateNews()
    const fetchMoreData = async () => {   
      ...
      console.log(articles.length)
        ...
        return (
            <>
                <h1 className="text-center" style={{ margin: '35px 0px', marginTop: '90px',fontFamily: "Oswald, sans-serif" }}> <strong> NewsGorilla - Top {capitalizeFirstLetter(props.category)} Headlines </strong></h1>
                {loading && <Spinner />}
